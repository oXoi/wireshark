...
static uint32_t get_uint_hex_parameter(const uint8_t *parameter_stream, int parameter_length)
{
    uint32_t       value;
    const uint8_t *unused;

    ws_hexbuftou32(parameter_stream, parameter_length, &unused, &value);
